...
Pod::Spec.new do |s|
  ...
  s.name         = "CJSCToolKits"
  s.version      = "0.0.1"
  s.summary      = "A short description of CJSCToolKits."
...
12345567890
  ...
  s.homepage     = "https://github.com/appledev201888/CJSCToolKits"
  ...
  s.source       = { :git => "https://github.com/appledev201888/CJSCToolKits.git", :tag => "#{s.version}" }
